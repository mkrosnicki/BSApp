            ...
            children: [
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: isUserLoggedIn ? isFavourite ? Icon(Icons.favorite, size: 24,) : Icon(Icons.favorite_border, size: 24,) : Icon(null),
                ),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(
              vertical: 10.0, horizontal: 8.0),
          child: Text('Komentarze', style: TextStyle(fontSize: 16)),
        ),
      ),
    );
  }
