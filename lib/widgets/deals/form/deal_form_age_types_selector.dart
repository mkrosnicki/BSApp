...
class DealsFormAgeTypesSelector extends StatelessWidget {
  final AddDealModel addDealModel;
  final Function(List<AgeType>) onSelection;

  DealsFormAgeTypesSelector(this.addDealModel, this.onSelection);

  List<AgeType> selectedAgeTypes = [];

  @override
  Widget build(BuildContext context) {
    selectedAgeTypes = addDealModel.ageTypes;
    return InkWell(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'Wiek dziecka (opcjonalnie)',
                          style: TextStyle(fontSize: 11, color: Colors.grey, height: 1.3),
                        ),
                        Text(
                          addDealModel.ageTypes != null && addDealModel.ageTypes.isNotEmpty
                              ? _ageTypesString(addDealModel.ageTypes)
                              : "Dowolny",
  ...
  bool _isSelected(final AgeType ageType) {
    return addDealModel.ageTypes.contains(ageType);
  }
