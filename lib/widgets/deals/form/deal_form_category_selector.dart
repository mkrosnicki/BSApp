...
class DealsFormCategorySelector extends StatelessWidget {
  final List<CategoryModel> categories;
  final GestureTapCallback onTap;

  const DealsFormCategorySelector(this.categories, this.onTap);
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      categories != null && categories.isNotEmpty ? categories[0].name : "Wybierz kategorię*",
