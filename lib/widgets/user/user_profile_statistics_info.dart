...
class UserProfileStatisticsInfo extends StatefulWidget {
  @override
  _UserProfileStatisticsInfoState createState() =>
      _UserProfileStatisticsInfoState();
}
...
class _UserProfileStatisticsInfoState extends State<UserProfileStatisticsInfo> {
  ...
  Widget _buildMenuItem(String label, int index, bool borderLeft, bool borderRight) {
    return Flexible(
