...
class MyIconsProvider {
  ...
  static const Icon FORWARD_ICON = Icon(CupertinoIcons.back, color: Colors.white);
  static const Icon FORWARD_BLACK_ICON = Icon(CupertinoIcons.back, color: Colors.black);
  static const Icon FORWARD_WHITE_ICON = Icon(CupertinoIcons.back, color: Colors.white);
